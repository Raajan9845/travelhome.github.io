...
<section class="home-packages">
   ...
   <div class="box-container">
      ...
      <div class="box">
         ...
         <div class="content">
            <h3>Langtang Trek</h3>
            <p>Langtang Valley Trek is a distinguished destination that leads to discovering astonishing peaks with an amusing walk. It’s a great occasion to see the Langtang glacier, various landscapes, an old Buddhist monastery, a local cheese factory, marvelous mountains .</p>
            <a href="book.php" class="btn">book now</a>
         </div>
      </div> -->
